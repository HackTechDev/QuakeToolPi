...
/*
Always create a good tree, otherwise hint faces won't work if there's a leak.
- Alexander Malmberg
*/
...
int main (int argc, char **argv)
{
   ...
   printf("---- qbsp ----\n"
          ...
          "\n"
          "This version of qbsp supports detail brushes and will only work with versions\n"
